...
function buildKeyframes(
  ...
  keys.forEach(k => {
    ...
    keyframes[k] = [f[k], ...steps.map(s => (s as Record<string, unknown>)[k])]
  })
...
export default function BlurText({
  ...
  const fromSnapshot: TargetAndTransition = animationFrom ?? defaultFrom
  const toSnapshots: TargetAndTransition[] = animationTo ?? defaultTo
